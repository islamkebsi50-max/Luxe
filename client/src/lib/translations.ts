...
export const translations = {
  en: {
    ...
    priceUsd: "Price (DZD)",
    imageUrls: "Image URLs (up to 4)",
    mainImage: "Main image (required)",
    additionalImage: "Additional image",
    imageHint: "You can add up to 4 images total. At least the main image is required.",
    category: "Category",
  ...
  ar: {
    ...
    priceUsd: "السعر (د.ج)",
    imageUrls: "روابط الصور (حتى 4)",
    mainImage: "الصورة الرئيسية (مطلوبة)",
    additionalImage: "صورة إضافية",
    imageHint: "يمكنك إضافة حتى 4 صور. الصورة الرئيسية مطلوبة على الأقل.",
    category: "الفئة",
